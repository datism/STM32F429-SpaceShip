...
extern touchgfx::GeneratedFont& getFont_ARCADE_N_TTF_20_4bpp();
extern touchgfx::GeneratedFont& getFont_ARCADE_N_TTF_9_8bpp();
extern touchgfx::GeneratedFont& getFont_ARCADE_N_TTF_5_8bpp();

const touchgfx::Font* touchgfx_fonts[] = {
    &(getFont_ARCADE_N_TTF_20_4bpp()),
    &(getFont_ARCADE_N_TTF_9_8bpp()),
    &(getFont_ARCADE_N_TTF_5_8bpp())
};
...
void resetFont(touchgfx::FontId fontId)
{
    ...
    {
    case 0:
        touchgfx_fonts[0] = &(getFont_ARCADE_N_TTF_20_4bpp());
        break;
    case 1:
        touchgfx_fonts[1] = &(getFont_ARCADE_N_TTF_9_8bpp());
        break;
    case 2:
        touchgfx_fonts[2] = &(getFont_ARCADE_N_TTF_5_8bpp());
        break;
    }
}
} // namespace TypedTextDatabase
