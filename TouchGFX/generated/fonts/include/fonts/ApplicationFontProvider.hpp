...
{
    static const touchgfx::FontId LARGE = 0;  // ARCADE_N_TTF_20_4bpp
    static const touchgfx::FontId NORMAL = 1; // ARCADE_N_TTF_9_8bpp
    static const touchgfx::FontId SMALL = 2;  // ARCADE_N_TTF_5_8bpp
